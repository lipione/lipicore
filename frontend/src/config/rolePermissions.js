...
export const PERMISSIONS = {
  ...
  VIEW_MARKET_TIME: 'view_market_time',
  VIEW_NOTIFICATIONS: 'view_notifications',
  VIEW_CEO_MESSAGES: 'view_ceo_messages',
  VIEW_STAFF_INBOX: 'view_staff_inbox',
  VIEW_KNOWLEDGE_GAPS: 'view_knowledge_gaps',
  VIEW_POLICY_CHANGES: 'view_policy_changes',
  VIEW_COMPLAINT_WORKSPACE: 'view_complaint_workspace',
  VIEW_CIRCULAR_IMPACT: 'view_circular_impact',
  VIEW_BRANCH_RESPONSES: 'view_branch_responses',
  VIEW_KYC_CASE_PREP: 'view_kyc_case_prep',
  VIEW_CHECKLIST_WORKSPACE: 'view_checklist_workspace',
  VIEW_AUDIT_EVIDENCE: 'view_audit_evidence',
  ...
  MANAGE_BANK_FEATURES: 'manage_bank_features',
  MANAGE_MARKET_RATES: 'manage_market_rates',
  MANAGE_NOTIFICATIONS: 'manage_notifications',
  MANAGE_CEO_MESSAGES: 'manage_ceo_messages',
  VIEW_TASKS: 'view_tasks',
};

const BANKING_WORKFLOW_PERMISSIONS = [
  PERMISSIONS.VIEW_COMPLAINT_WORKSPACE,
  PERMISSIONS.VIEW_CIRCULAR_IMPACT,
  PERMISSIONS.VIEW_BRANCH_RESPONSES,
  PERMISSIONS.VIEW_KYC_CASE_PREP,
  PERMISSIONS.VIEW_CHECKLIST_WORKSPACE,
  PERMISSIONS.VIEW_AUDIT_EVIDENCE,
];
...
const ROLE_PERMISSIONS = {
  staff_user: [
    ...
    PERMISSIONS.VIEW_MARKET_TIME,
    PERMISSIONS.VIEW_NOTIFICATIONS,
    PERMISSIONS.VIEW_CEO_MESSAGES,
    PERMISSIONS.VIEW_STAFF_INBOX,
    PERMISSIONS.VIEW_KNOWLEDGE_GAPS,
    PERMISSIONS.VIEW_POLICY_CHANGES,
    ...BANKING_WORKFLOW_PERMISSIONS,
  ],
  compliance_user: [
    PERMISSIONS.USE_CHAT,
    PERMISSIONS.USE_CHAT_FILE_UPLOAD,
  ...
  bank_admin: [
    ...
    PERMISSIONS.VIEW_REGULATORY_LIBRARY,
    PERMISSIONS.MANAGE_COMPLIANCE,
    PERMISSIONS.MANAGE_MARKET_RATES,
    PERMISSIONS.MANAGE_NOTIFICATIONS,
    PERMISSIONS.MANAGE_CEO_MESSAGES,
