...
router = APIRouter()
WORKFLOW_TYPE = "complaint_workspace"
...
def create_complaint_case(payload: BankingWorkflowCaseCreate, db: Session = Depends(get_session), current_user: User = Depends(get_current_user)):
