...
router = APIRouter()
WORKFLOW_TYPE = "branch_response_builder"
...
def create_branch_response(payload: BankingWorkflowCaseCreate, db: Session = Depends(get_session), current_user: User = Depends(get_current_user)):
